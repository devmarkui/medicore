...
INSERT IGNORE INTO service_categories (category_name, icon_class, display_order, is_active, description)
VALUES
...
INSERT IGNORE INTO service_items (item_code, item_name, category_id, price, is_active, display_order, description)
VALUES
    ...
    ('PROC002', 'Dressing Care', 6, 400.00, TRUE, 2, 'Wound dressing and management'),
